...
// Identical to the ATmega2560, except that it only has timers 0, 1, and 3. For
// this to work, timer registers have been swapped a bit (3->2)
...
static struct avr_register regmap[] = {
    ...
    { .type = REG_EEP_CONTROL },   // EECR (0x3f)
    { .type = REG_VALUE },         // EEDR (0x40)
    { .type = REG_VALUE },         // EEARL (0x41)
    { .type = REG_VALUE },         // EEARH (0x42)
    { .type = REG_VALUE },         // GTCCR (0x43)
    { .type = REG_TIMER0_CTRL },   // TCCR0A (0x44)
    { .type = REG_TIMER0_CTRL },   // TCCR0B (0x45)
    ...
    { .type = REG_SPM_CONTROL },   // SPMCSR (0x57)
    ...
    { .type = REG_TIMER1_CTRL },   // TCCR1A (0x80)
    { .type = REG_TIMER1_CTRL },   // TCCR1B (0x81)
    { .type = REG_TIMER1_CTRL },   // TCCR1C (0x82)
    ...
    { .type = REG_TIMER2_CTRL },   // TCCR3A (0x90)
    { .type = REG_TIMER2_CTRL },   // TCCR3B (0x91)
    { .type = REG_TIMER2_CTRL },   // TCCR3C (0x92)
    { .type = REG_RESERVED },      // Reserved (0x93)
    { .type = REG_TIMER2_LOW },    // TCNT3L (0x94)
    { .type = REG_TIMER2_HIGH },   // TCNT3H (0x95)
    { .type = REG_VALUE },         // ICR3L (0x96)
    { .type = REG_VALUE },         // ICR3H (0x97)
    { .type = REG_TIMER2_LOW },    // OCR3AL (0x98)
    { .type = REG_TIMER2_HIGH },   // OCR3AH (0x99)
    { .type = REG_TIMER2_LOW },    // OCR3BL (0x9a)
    { .type = REG_TIMER2_HIGH },   // OCR3BH (0x9b)
    { .type = REG_TIMER2_LOW },    // OCR3CL (0x9c)
    { .type = REG_TIMER2_HIGH },   // OCR3CH (0x9d)
    { .type = REG_RESERVED },      // Reserved (0x9e)
    { .type = REG_RESERVED },      // Reserved (0x9f)
    { .type = REG_TIMER4_CTRL },   // TCCR4A (0xa0)
    { .type = REG_TIMER4_CTRL },   // TCCR4B (0xa1)
    { .type = REG_TIMER4_CTRL },   // TCCR4C (0xa2)
    ...
    { .type = REG_TIMER2_CTRL },   // TCCR2A (0xb0)
    { .type = REG_TIMER2_CTRL },   // TCCR2B (0xb1)
    ...
    { .type = REG_TIMER5_CTRL },   // TCCR5A (0x120)
    { .type = REG_TIMER5_CTRL },   // TCCR5B (0x121)
    { .type = REG_TIMER5_CTRL },   // TCCR5C (0x122)
...
const struct avr_model AFTERZHEV_MINIMAL_MODEL = {
    .romsize        = 256*1024,
    .regsize        = 512,
    .ramsize        = 8*1024,
    .eepsize        = 4*1024,
    ...
    .reg_eedr       = 0x40,
    .port_count     = 12,
    .reg_pins       = (uint16_t[]){ 0x20, 0x23, 0x26, 0x29, 0x2c, 0x2f, 0x32, 0x100, 0x0000, 0x103, 0x106, 0x109 },
    .reg_ports      = (uint16_t[]){ 0x22, 0x25, 0x28, 0x2b, 0x2e, 0x31, 0x34, 0x102, 0x0000, 0x105, 0x108, 0x10b },
    .reg_ddrs       = (uint16_t[]){ 0x21, 0x24, 0x27, 0x2a, 0x2d, 0x30, 0x33, 0x101, 0x0000, 0x104, 0x107, 0x10a },
    .vec_spmrdy     = 0xa0,
    .vec_eerdy      = 0x78,
