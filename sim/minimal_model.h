...
static struct avr_register regmap[] = {
    ...
    { .type = REG_TIMER3_CTRL },   // TCCR0A (0x44)
    { .type = REG_TIMER3_CTRL },   // TCCR0B (0x45)
    { .type = REG_VALUE },         // TCNT0  (0x46)
    { .type = REG_TIMER3_LOW },    // OCR0A  (0x47)
    { .type = REG_TIMER3_LOW },    // OCR0B  (0x48)
    ...
    { .type = REG_TIMER0_CTRL },   // TCCR1A (0x80)
    { .type = REG_TIMER0_CTRL },   // TCCR1B (0x81)
    { .type = REG_TIMER0_CTRL },   // TCCR1C (0x82)
    { .type = REG_RESERVED },      // Reserved (0x83)
    { .type = REG_TIMER0_LOW },    // TCNT1L (0x84)
    { .type = REG_TIMER0_HIGH },   // TCNT1H (0x85)
    { .type = REG_VALUE },         // ICR1L (0x86)
    { .type = REG_VALUE },         // ICR1H (0x87)
    { .type = REG_TIMER0_LOW },    // OCR1AL (0x88)
    { .type = REG_TIMER0_HIGH },   // OCR1AH (0x89)
    { .type = REG_TIMER0_LOW },    // OCR1BL (0x8a)
    { .type = REG_TIMER0_HIGH },   // OCR1BH (0x8b)
    { .type = REG_TIMER0_LOW },    // OCR1CL (0x8c)
    { .type = REG_TIMER0_HIGH },   // OCR1CH (0x8d)
    { .type = REG_RESERVED },      // Reserved (0x8e)
    { .type = REG_RESERVED },      // Reserved (0x8f)
    { .type = REG_TIMER1_CTRL },   // TCCR3A (0x90)
    { .type = REG_TIMER1_CTRL },   // TCCR3B (0x91)
    { .type = REG_TIMER1_CTRL },   // TCCR3C (0x92)
    { .type = REG_RESERVED },      // Reserved (0x93)
    { .type = REG_TIMER1_LOW },    // TCNT3L (0x94)
    { .type = REG_TIMER1_HIGH },   // TCNT3H (0x95)
    { .type = REG_VALUE },         // ICR3L (0x96)
    { .type = REG_VALUE },         // ICR3H (0x97)
    { .type = REG_TIMER1_LOW },    // OCR3AL (0x98)
    { .type = REG_TIMER1_HIGH },   // OCR3AH (0x99)
    { .type = REG_TIMER1_LOW },    // OCR3BL (0x9a)
    { .type = REG_TIMER1_HIGH },   // OCR3BH (0x9b)
    { .type = REG_TIMER1_LOW },    // OCR3CL (0x9c)
    { .type = REG_TIMER1_HIGH },   // OCR3CH (0x9d)
