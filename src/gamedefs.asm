...
.equ MODE_HELP = 3
.equ MODE_ABOUT = 4
.equ MODE_CHARACTER = 5
.equ MODE_EXPLORE = 6
.equ MODE_INVENTORY = 7
.equ MODE_SHOPPING = 8
.equ MODE_CONVERSATION = 9
.equ MODE_UPGRADE = 10
.equ MODE_GAMEOVER = 11
.equ MODE_CREDITS = 12
...
.equ EFFECT_POTION = 3
.equ EFFECT_POTION_DURATION = 4
.equ EFFECT_POTION_DELAY = 1
.equ EFFECT_POTION_FRAME_DURATION_MASK = 0x07
.equ EFFECT_UPGRADE = 4
.equ EFFECT_UPGRADE_DURATION = 4
.equ EFFECT_UPGRADE_DELAY = 3
.equ EFFECT_UPGRADE_FRAME_DURATION_MASK = 0x07
.equ EFFECT_ARROW = 5
.equ EFFECT_FIREBALL = 6
.equ EFFECT_FIREBALL_DURATION = 6
.equ EFFECT_FIREBALL_FRAME_DURATION_MASK = 0x3
.equ EFFECT_MISSILE = 7
.equ EFFECT_MISSILE_DURATION = 4
.equ EFFECT_MISSILE_FRAME_DURATION_MASK = 0x3

; used for ranged NPC attacks
.equ EFFECT_ARROW_RANGE_ESTIMATE = 120
...
.equ SAVEPOINT_DISTANCE = 8
.equ SAVEPOINT_MAGIC = 42

.equ PORTAL_DISTANCE = 8

.equ MAX_FEATURE_COLLIDE_IDX = 18
