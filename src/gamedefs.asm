...
.equ END_UPPER_LEFT_BLOCKING_IDX = 5
.equ END_LOWER_RIGHT_BLOCKING_IDX = 11
.equ END_LOWER_LEFT_BLOCKING_IDX = 18
.equ END_UPPER_RIGHT_BLOCKING_IDX = 23
.equ END_FULL_BLOCKING_IDX = 158

.equ FULL_BLOCKING_MARGIN = 1
