...
_item_str_wood_stick_desc:      .db "A plain wooden stick.", 0
_item_str_health_potion_name:   .db "Healing Potion", 0, 0
_item_str_health_potion_desc:   .db 0, 0
_item_str_mint_soda_name:       .db "Questionable Liquid", 0
_item_str_mint_soda_desc:       .db "Smells vaguely of mint.", 0
_item_str_mint_leaves_name:     .db "Useless Mint Leaves", 0
_item_str_mint_leaves_desc:     .db 0, 0
