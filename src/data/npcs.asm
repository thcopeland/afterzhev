...
npc_table:
    ...
    DECL_TALK_DATA  NO_NPC, CONVERSATION_welcome_to_haldir_ID, haldir1, 0, haldir2, NPC_HALDIR_GUARD_ANGRY
    ...
    DECL_TALK_DATA  NO_NPC, 0, no_message, 0, no_message, NPC_HALDIR_GUARD_ANGRY
    ...
    DECL_NPC        NPC_FIELD_QUESTGIVER, NPC_TALKER, CHARACTER_MAN, NO_ITEM, ITEM_feathered_hat, DIRECTION_DOWN, 20, 70, 22
