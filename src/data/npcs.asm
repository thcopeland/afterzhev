...
npc_table:
    ...
    DECL_NPC        NPC_ZHEV2, NPC_ENEMY, CHARACTER_CULTIST, ITEM_ivory_wand, ITEM_iron_breastplate_cloak, DIRECTION_DOWN, 50, 120, 90
    DECL_ENEMY_DATA NPC_ATTACK|NPC_MOVE_CIRCLE, 200, 5, 11, 8, NO_ITEM, NO_ITEM, NO_ITEM
