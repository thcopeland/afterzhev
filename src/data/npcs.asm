...
npc_table:
    ...
    DECL_ENEMY_DATA NPC_PATROL, 20, 8, 6, 3, NO_ITEM, ITEM_large_health_potion, ITEM_strength_potion
    ...
    DECL_NPC        NPC_ALCHEMIST, NPC_SHOPKEEPER, CHARACTER_ELF, NO_ITEM, ITEM_purple_hood, DIRECTION_DOWN, 20, 121, 58
    ...
    DECL_NPC        NPC_CITIZEN_1, NPC_TALKER, CHARACTER_ELF, NO_ITEM, NO_ITEM, DIRECTION_LEFT, 20, 43, 153
    ...
    DECL_ENEMY_DATA NPC_ATTACK|NPC_MOVE_CIRCLE, 200, 7, 11, 10, ITEM_letter, ITEM_letter, ITEM_letter

    DECL_NPC        NPC_ZHEV2, NPC_ENEMY, CHARACTER_CULTIST, ITEM_ivory_wand, ITEM_iron_breastplate_cloak, DIRECTION_DOWN, 60, 120, 90
    DECL_ENEMY_DATA NPC_ATTACK|NPC_MOVE_CIRCLE, 200, 7, 11, 10, NO_ITEM, NO_ITEM, NO_ITEM
