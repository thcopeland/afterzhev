...
npc_table:
    ...
    DECL_ENEMY_DATA 0, 0, 8, 3, 10, ITEM_raw_meat, ITEM_rotten_meat, 128|5

    DECL_NPC        NPC_FOX_2, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_DOWN, 10, 168, 147
    DECL_ENEMY_DATA 0, 0, 9, 3, 10, ITEM_raw_meat, ITEM_rotten_meat, 128|5
    ...
    DECL_NPC        NPC_KIDNAPPED_DAUGHTER, NPC_ENEMY, CHARACTER_MAGE, NO_ITEM, ITEM_kidnapped_hair, DIRECTION_RIGHT, 10, 128, 25
    DECL_ENEMY_DATA 0, 0, 8, 0, 0, 0, 0, 0
