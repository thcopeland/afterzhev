...
npc_table:
    ...
    DECL_NPC        NPC_BANDIT_2, NPC_ENEMY, CHARACTER_MAN, ITEM_bloody_sword, ITEM_purple_hood, DIRECTION_UP, 15, 136, 140
    DECL_ENEMY_DATA NPC_GUARD, 15, 4, 2, 3, ITEM_purple_hood, 128|20, ITEM_bloody_sword

    DECL_NPC        NPC_BANDIT_2_REFORMED, NPC_ENEMY, CHARACTER_MAN, NO_ITEM, ITEM_purple_hood, DIRECTION_UP, 15, 136, 140
