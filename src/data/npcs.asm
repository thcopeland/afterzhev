...
npc_table:
    ...
    DECL_NPC        NPC_FOX_1, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_RIGHT, 6, 24, 24
    ...
    DECL_NPC        NPC_TOWN_BLACKSMITH, NPC_SHOPKEEPER, 128|NPC_BLACKSMITH_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 30, 183, 93
