...
npc_table:
    ...
    DECL_NPC        NPC_CULTIST_3, NPC_ENEMY, CHARACTER_CULTIST, ITEM_steel_sword, NO_ITEM, DIRECTION_UP, 40, 44, 88
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 5, 2, ITEM_health_potion, ITEM_large_health_potion, ITEM_mint_tonic

    DECL_NPC        NPC_CULTIST_4, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_UP, 30, 100, 88
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 6, 2, NO_ITEM, ITEM_large_health_potion, ITEM_strength_potion

    DECL_NPC        NPC_CULTIST_5, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_RIGHT, 25, 38, 129
    DECL_ENEMY_DATA NPC_ATTACK, 30, 5, 5, 2, NO_ITEM, ITEM_whiskey, ITEM_axe

    DECL_NPC        NPC_CULT_VICTIM, NPC_ENEMY, CHARACTER_BANDIT, NO_ITEM, NO_ITEM, DIRECTION_LEFT, 15, 52, 136
    DECL_ENEMY_DATA NPC_STOLID, 0, 6, 5, 2, NO_ITEM, ITEM_whiskey, ITEM_axe

    DECL_NPC        NPC_CULTIST_6, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_RIGHT, 25, 63, 140
