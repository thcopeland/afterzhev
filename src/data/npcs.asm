...
npc_table:
    ...
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 30, 7, 3, 2, ITEM_steel_sword, 128|50, 128|ITEM_health_potion

    DECL_NPC        NPC_UNDERCOVER_GOON1, NPC_ENEMY, CHARACTER_BANDIT, ITEM_wooden_bow, ITEM_green_hood, DIRECTION_UP, 15, 144, 66
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 20, 6, 2, 1, 128|25, 128|50, 128|ITEM_health_potion

    DECL_NPC        NPC_UNDERCOVER_GOON2, NPC_ENEMY, CHARACTER_BANDIT, ITEM_bloody_sword, ITEM_green_hood, DIRECTION_UP, 15, 130, 66
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 20, 6, 2, 2, 128|25, 128|50, 128|ITEM_health_potion
