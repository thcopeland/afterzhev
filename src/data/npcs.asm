...
npc_table:
    ...
    DECL_NPC        NPC_BANDIT_1, NPC_ENEMY, CHARACTER_BANDIT, ITEM_bloody_sword, ITEM_green_hood, DIRECTION_LEFT, 15, 108, 73
    DECL_ENEMY_DATA NPC_GUARD, 15, 6, 2, 2, 128|20, ITEM_green_hood, ITEM_green_hood

    DECL_NPC        NPC_BANDIT_2, NPC_ENEMY, CHARACTER_MAN, ITEM_bloody_sword, ITEM_purple_hood, DIRECTION_UP, 18, 136, 140
    DECL_ENEMY_DATA NPC_GUARD, 15, 4, 1, 3, ITEM_purple_hood, 128|20, ITEM_bloody_sword

    DECL_NPC        NPC_BANDIT_2_REFORMED, NPC_ENEMY, CHARACTER_MAN, NO_ITEM, ITEM_purple_hood, DIRECTION_UP, 18, 136, 140
    DECL_ENEMY_DATA NPC_MOVE_LOOKAT, 0, 0, 0, 0, ITEM_purple_hood, 128|20, ITEM_bloody_sword

    DECL_NPC        NPC_DRUNK, NPC_TALKER, 128|NPC_DRUNK_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_LEFT, 15, 165, 26
    DECL_TALK_DATA  NPC_TOWN_GUARD_ANGRY, CONVERSATION_drunks_warning_ID, drunks_warning, 0, drunks_warning2, NO_NPC

    DECL_NPC        NPC_GRIEVING_FATHER, NPC_TALKER, 128|NPC_GRIEVING_FATHER_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_LEFT, 20, 82, 132
    DECL_TALK_DATA  NPC_TOWN_GUARD_ANGRY, 0, kidnapped, 0, END_CONVERSATION, NO_NPC

    DECL_NPC        NPC_FOX_1, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_RIGHT, 6, 12, 24
    DECL_ENEMY_DATA NPC_GUARD, 5, 7, 2, 0, ITEM_raw_meat, ITEM_rotten_meat, 128|5

    DECL_NPC        NPC_FOX_2, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_DOWN, 6, 168, 147
    DECL_ENEMY_DATA NPC_GUARD, 5, 7, 2, 0, ITEM_raw_meat, ITEM_rotten_meat, 128|5
    ...
    DECL_NPC        NPC_FOX_4, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_LEFT, 6, 190, 120
    DECL_ENEMY_DATA NPC_GUARD, 5, 7, 2, 0, ITEM_raw_meat, ITEM_rotten_meat, 128|5

    DECL_NPC        NPC_FOX_5, NPC_ENEMY, CHARACTER_FOX, ITEM_invisible_weapon, NO_ITEM, DIRECTION_UP, 8, 50, 140
    DECL_ENEMY_DATA NPC_GUARD, 5, 6, 2, 0, ITEM_raw_meat, ITEM_raw_meat, 128|5

    DECL_NPC        NPC_KIDNAPPED, NPC_TALKER, CHARACTER_CHILD, NO_ITEM, NO_ITEM, DIRECTION_RIGHT, 20, 128, 25
    DECL_TALK_DATA  NO_NPC, CONVERSATION_rescue_kidnapped_ID, rescue_kidnapped, 0, END_CONVERSATION, NO_NPC

    DECL_NPC        NPC_KIDNAPPED_FOLLOWING, NPC_ENEMY, CHARACTER_CHILD, NO_ITEM, NO_ITEM, DIRECTION_RIGHT, 20, 128, 25
    DECL_ENEMY_DATA NPC_FOLLOW, 0, 5, 0, 5, NO_ITEM, NO_ITEM, NO_ITEM

    DECL_NPC        NPC_FISHERMAN, NPC_TALKER, 128|NPC_FISHERMAN_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_LEFT, 20, 146, 90
    DECL_TALK_DATA  NPC_TOWN_GUARD_ANGRY, CONVERSATION_nice_day_ID, nice_day, 0, nice_day3, NO_NPC

    DECL_NPC        NPC_WELCOME, NPC_TALKER, 128|NPC_WELCOME_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 20, 156, 133
    DECL_TALK_DATA  NPC_TOWN_GUARD_ANGRY, CONVERSATION_welcome_ID, welcome, 0, welcome3, NO_NPC

    DECL_NPC        NPC_TAVERN_SIGN, NPC_TALKER, 128|NPC_SIGN_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 20, 140, 100
    DECL_TALK_DATA  NO_NPC, 0, tavern_sign, 0, tavern_sign, NO_NPC

    DECL_NPC        NPC_DRINKER1, NPC_SPECIAL, 128|NPC_DRINKER_DOWN_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 10, 105, 66
    DECL_SPECIAL_DATA 0, 0, 0, 0, 0, 0, 0, 0

    DECL_NPC        NPC_DRINKER2, NPC_SPECIAL, 128|NPC_DRINKER_UP_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_UP, 10, 112, 78
    DECL_SPECIAL_DATA 0, 0, 0, 0, 0, 0, 0, 0

    DECL_NPC        NPC_BARTENDER, NPC_SHOPKEEPER, 128|NPC_BUSINESSMAN_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 20, 71, 112
    DECL_SHOP_DATA  NPC_TOWN_GUARD_ANGRY, SHOP_bartender_ID

    DECL_NPC        NPC_DRUNK2, NPC_TALKER, 128|NPC_DRUNK_2_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 15, 77, 38
    DECL_TALK_DATA  NPC_TOWN_GUARD_ANGRY, CONVERSATION_drunk_hiccup_ID, drunk_hiccup, 0, drunk_hiccup5, NO_NPC

    DECL_NPC        NPC_ANNOYED_GUEST, NPC_TALKER, CHARACTER_BANDIT, NO_ITEM, ITEM_feathered_hat, DIRECTION_DOWN, 25, 192, 40
    ...
    DECL_NPC        NPC_TOWN_BLACKSMITH, NPC_SHOPKEEPER, 128|NPC_BLACKSMITH_SPRITE, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 30, 180, 100
    DECL_SHOP_DATA  NPC_TOWN_GUARD_ANGRY, SHOP_blacksmith_ID

    DECL_NPC        NPC_UNDERCOVER_BANDIT, NPC_TALKER, CHARACTER_MAN, NO_ITEM, ITEM_green_cloak, DIRECTION_LEFT, 25, 111, 90
    DECL_TALK_DATA  NO_NPC, CONVERSATION_bandit_lies_ID, bandit_lies1, 0, bandit_good_luck, NPC_UNDERCOVER_BANDIT_UNMASKED

    DECL_NPC        NPC_UNDERCOVER_BANDIT_UNMASKED, NPC_ENEMY, CHARACTER_MAN, ITEM_steel_sword, ITEM_green_cloak, DIRECTION_UP, 25, 139, 60
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 40, 7, 3, 2, ITEM_steel_sword, 128|50, ITEM_health_potion

    DECL_NPC        NPC_UNDERCOVER_GOON1, NPC_ENEMY, CHARACTER_BANDIT, ITEM_wooden_bow, ITEM_full_green_cloak, DIRECTION_UP, 20, 144, 66
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 25, 5, 1, 2, ITEM_green_hood, ITEM_green_cloak, ITEM_health_potion

    DECL_NPC        NPC_UNDERCOVER_GOON2, NPC_ENEMY, CHARACTER_BANDIT, ITEM_steel_sword, ITEM_green_hood, DIRECTION_UP, 20, 130, 66
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 25, 4, 3, 2, ITEM_steel_sword, 128|50, ITEM_health_potion
    ...
    DECL_NPC        NPC_BANDIT_GUARD_2, NPC_ENEMY, CHARACTER_BANDIT, ITEM_club, ITEM_feathered_hat, DIRECTION_DOWN, 20, 143, 75
    DECL_ENEMY_DATA NPC_GUARD, 20, 6, 2, 1, ITEM_club, ITEM_feathered_hat, NO_ITEM

    DECL_NPC        NPC_DEN_BANDIT_1, NPC_ENEMY, CHARACTER_BANDIT, ITEM_steel_sword, ITEM_leather_armor, DIRECTION_DOWN, 30, 172, 40
    DECL_ENEMY_DATA NPC_ATTACK, 25, 6, 3, 3, 128|30, ITEM_leather_armor, NO_ITEM

    DECL_NPC        NPC_DEN_BANDIT_2, NPC_ENEMY, CHARACTER_BANDIT, ITEM_wooden_bow, ITEM_green_hood, DIRECTION_DOWN, 30, 126, 75
    DECL_ENEMY_DATA NPC_ATTACK, 25, 6, 2, 2, ITEM_wooden_bow, ITEM_green_hood, NO_ITEM

    DECL_NPC        NPC_DEN_BANDIT_3, NPC_ENEMY, CHARACTER_BANDIT, ITEM_steel_sword, ITEM_leather_armor, DIRECTION_DOWN, 30, 130, 27
    DECL_ENEMY_DATA NPC_GUARD, 25, 6, 5, 3, ITEM_leather_armor, 128|30, NO_ITEM

    DECL_NPC        NPC_DEN_BANDIT_CHIEF, NPC_ENEMY, CHARACTER_BANDIT, ITEM_iron_staff, ITEM_full_purple_cloak, DIRECTION_DOWN, 40, 65, 86
    DECL_ENEMY_DATA NPC_ATTACK, 200, 7, 8, 3, ITEM_iron_staff, ITEM_iron_staff, ITEM_iron_staff
    ...
    DECL_ENEMY_DATA NPC_ATTACK, 40, 6, 4, 4, ITEM_axe, ITEM_iron_breastplate, ITEM_strength_potion

    DECL_NPC        NPC_BRIDGE_BANDIT_2, NPC_ENEMY, CHARACTER_BANDIT, ITEM_axe, ITEM_green_cloak, DIRECTION_RIGHT, 30, 89, 105
    DECL_ENEMY_DATA NPC_ATTACK, 40, 8, 4, 2, ITEM_strength_potion, ITEM_bismuth_subsalicylate, ITEM_axe

    DECL_NPC        NPC_BRIDGE_BANDIT_3, NPC_ENEMY, CHARACTER_BANDIT, ITEM_great_bow, ITEM_green_hood, DIRECTION_RIGHT, 30, 89, 105
    DECL_ENEMY_DATA NPC_ATTACK, 40, 6, 4, 2, ITEM_great_bow, ITEM_bismuth_subsalicylate, ITEM_strength_potion
    ...
    DECL_NPC        NPC_CULTIST_1, NPC_ENEMY, CHARACTER_CULTIST, ITEM_steel_sword, NO_ITEM, DIRECTION_DOWN, 40, 135, 42
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 5, 2, ITEM_health_potion, ITEM_large_health_potion, ITEM_mint_tonic

    DECL_NPC        NPC_CULTIST_2, NPC_ENEMY, CHARACTER_CULTIST, ITEM_bloody_sword, NO_ITEM, DIRECTION_DOWN, 30, 47, 57
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 4, 2, NO_ITEM, ITEM_large_health_potion, ITEM_strength_potion

    DECL_NPC        NPC_CULTIST_3, NPC_ENEMY, CHARACTER_CULTIST, ITEM_steel_sword, NO_ITEM, DIRECTION_UP, 40, 164, 120
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 5, 2, ITEM_health_potion, ITEM_large_health_potion, ITEM_mint_tonic

    DECL_NPC        NPC_CULTIST_4, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_UP, 30, 83, 119
    DECL_ENEMY_DATA NPC_PATROL, 40, 6, 6, 2, NO_ITEM, ITEM_large_health_potion, ITEM_strength_potion

    DECL_NPC        NPC_CULTIST_5, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_RIGHT, 25, 35, 115
    DECL_ENEMY_DATA NPC_ATTACK, 30, 5, 5, 2, NO_ITEM, ITEM_whiskey, ITEM_axe

    DECL_NPC        NPC_CULT_VICTIM, NPC_ENEMY, CHARACTER_BANDIT, NO_ITEM, NO_ITEM, DIRECTION_DOWN, 15, 38, 102
    DECL_ENEMY_DATA NPC_STOLID, 0, 6, 5, 2, NO_ITEM, ITEM_whiskey, ITEM_axe

    DECL_NPC        NPC_CULTIST_6, NPC_ENEMY, CHARACTER_CULTIST, ITEM_axe, NO_ITEM, DIRECTION_RIGHT, 25, 50, 99
    DECL_ENEMY_DATA NPC_ATTACK, 30, 6, 5, 2, NO_ITEM, ITEM_health_potion, ITEM_axe

    DECL_NPC        NPC_CULTIST_LEADER, NPC_ENEMY, CHARACTER_CULTIST, ITEM_iron_staff, NO_ITEM, DIRECTION_UP, 50, 126, 144
    ...
    DECL_ENEMY_DATA NPC_PATROL, 20, 7, 5, 2, ITEM_raw_meat, 128|5, 128|10
    ...
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 40, 6, 5, 3, ITEM_mint_tonic, ITEM_purple_hood, NO_ITEM

    DECL_NPC        NPC_THIEF_2, NPC_ENEMY, CHARACTER_MAN, ITEM_steel_sword, ITEM_iron_breastplate, DIRECTION_DOWN, 30, 157, 53
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 40, 6, 5, 4, ITEM_whiskey, ITEM_iron_breastplate, NO_ITEM

    DECL_NPC        NPC_THIEF_3, NPC_ENEMY, CHARACTER_BANDIT, ITEM_steel_sword, ITEM_iron_helmet, DIRECTION_DOWN, 30, 122, 41
    DECL_ENEMY_DATA NPC_MOVE_HOLD|NPC_ATTACK, 40, 6, 5, 3, ITEM_steel_sword, ITEM_iron_helmet, NO_ITEM
    ...
    DECL_ENEMY_DATA NPC_PATROL, 50, 6, 8, 6, ITEM_health_potion, ITEM_blessed_sword, ITEM_mithril_breastplate
    ...
    DECL_ENEMY_DATA NPC_ATTACK|NPC_MOVE_CIRCLE, 100, 5, 11, 6, NO_ITEM, NO_ITEM, NO_ITEM

.message "Unallocated NPCs: ", low(TOTAL_NPC_COUNT - __NPC_IDX + 1)
