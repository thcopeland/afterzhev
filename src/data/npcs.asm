...
npc_table:
    ...
    DECL_ENEMY_DATA 12, 40, 127, 10, 100, 10, 10, 1, 2, 3

    DECL_NPC        NPC_ENEMY, CHARACTER_PALADIN, 1, NO_ITEM, DIRECTION_DOWN, 48
    DECL_ENEMY_DATA 12, 0, 0, 10, 100, 10, 10, 1, 2, 3
    ...
    DECL_NPC        NPC_ENEMY, CHARACTER_PALADIN, 1, NO_ITEM, DIRECTION_DOWN, 48
    DECL_ENEMY_DATA 80, 0, 0, 10, 100, 10, 10, 1, 2, 3
    ...
    DECL_ENEMY_DATA 100, 0, 0, 10, 100, 10, 10, 1, 2, 3
