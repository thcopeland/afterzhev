...
sfx_drop:
    ...
    SFX_END
sfx_swing:
    SFX_NOTE WAVE_NOISE|2, 127, 0
    SFX_NOTE WAVE_NOISE|1, 96, 0
    SFX_NOTE WAVE_NOISE|1, 64, 0
    SFX_END
sfx_cast:
    SFX_NOTE WAVE_NOISE|4, 127, 0
    SFX_NOTE WAVE_NOISE|1, 100, 0
    SFX_NOTE WAVE_NOISE|1, 32, 0
    SFX_NOTE WAVE_NOISE|1, 16, 0
    SFX_NOTE WAVE_NOISE|1, 4, 0
    SFX_END
sfx_cast2: ; shorter and quieter, for NPCS
    SFX_NOTE WAVE_NOISE|SFX_FADE_OUT|3, 96, 0
    SFX_NOTE WAVE_NOISE|SFX_FADE_OUT|1, 48, 0
    SFX_NOTE WAVE_NOISE|SFX_FADE_OUT|2, 16, 0
    SFX_END
sfx_dash:
    SFX_NOTE WAVE_NOISE|1, 64, 0
...
sfx_level_up:
    ...
    SFX_END
sfx_talk1:
    SFX_NOTE WAVE_SAWTOOTH|8, 60, NOTE_A3
    SFX_END
sfx_talk2:
    SFX_NOTE WAVE_SAWTOOTH|8, 64, NOTE_B3
    SFX_END
sfx_talk3:
...
sfx_talk6:
    ...
    SFX_END
sfx_talk7:
    SFX_NOTE WAVE_SAWTOOTH|8, 60, NOTE_Ab4
    SFX_END
sfx_talk8:
    SFX_NOTE WAVE_SAWTOOTH|8, 64, NOTE_A3
    SFX_END
