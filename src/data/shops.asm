...
shop_table:
    ...
    DECL_SHOP_ITEMS ITEM_steel_sword, ITEM_steel_sword, ITEM_wood_staff, ITEM_iron_breastplate, ITEM_strength_potion, ITEM_hammer, ITEM_wooden_bow, ITEM_health_potion
    ...
    DECL_SHOP bridge_peddler, 5, 0x20 ; x+5
    DECL_SHOP_ITEMS ITEM_health_potion, ITEM_speed_potion, ITEM_purple_hood, ITEM_purple_cloak, ITEM_beer, ITEM_beer, NO_ITEM, NO_ITEM

    DECL_SHOP city_blacksmith, 20, 0x24 ; 1.125x+5
    DECL_SHOP_ITEMS ITEM_spear, ITEM_blessed_sword, ITEM_iron_helmet, ITEM_iron_breastplate, ITEM_great_bow, ITEM_mithril_cap, ITEM_purple_cloak, ITEM_axe
