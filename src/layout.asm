...
.equ SECTOR_MEMSIZE = SECTOR_WIDTH*SECTOR_HEIGHT + 4 + SECTOR_NPC_COUNT + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE + SECTOR_SAVEPOINT_MEMSIZE + 4
...
.equ SECTOR_HANDLERS_OFFSET = SECTOR_SAVEPOINT_OFFSET + SECTOR_SAVEPOINT_MEMSIZE
...
.equ SAVEPOINT_DATA_START = 0x100
