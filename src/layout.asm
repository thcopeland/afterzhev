...
.equ SECTOR_FEATURE_COUNT = 8
.equ SECTOR_FEATURE_MEMSIZE = 3
.equ SECTOR_MEMSIZE = SECTOR_WIDTH*SECTOR_HEIGHT + 4 + SECTOR_NPC_COUNT + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE + SECTOR_SAVEPOINT_MEMSIZE + SECTOR_PORTAL_COUNT*SECTOR_PORTAL_MEMSIZE + SECTOR_FEATURE_COUNT*SECTOR_FEATURE_MEMSIZE + 10
...
.equ SECTOR_UPDATE_OFFSET = SECTOR_FEATURES_OFFSET + SECTOR_FEATURE_COUNT*SECTOR_FEATURE_MEMSIZE
