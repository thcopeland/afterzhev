...
.equ SECTOR_MEMSIZE = SECTOR_WIDTH*SECTOR_HEIGHT + 4 + SECTOR_NPC_COUNT + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE + 4
...
.equ SECTOR_HANDLERS_OFFSET = SECTOR_ITEMS_OFFSET + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE
...
.equ ACTIVE_EFFECT_MEMSIZE = 3
.equ ACTIVE_EFFECT_DATA_OFFSET = 0
.equ ACTIVE_EFFECT_X_OFFSET = 1
.equ ACTIVE_EFFECT_Y_OFFSET = 2
