...
.equ SECTOR_MEMSIZE = SECTOR_WIDTH*SECTOR_HEIGHT + 4 + SECTOR_NPC_COUNT + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE + SECTOR_SAVEPOINT_MEMSIZE + SECTOR_AVENGER_PLACES_MEMSIZE + SECTOR_PORTAL_COUNT*SECTOR_PORTAL_MEMSIZE + SECTOR_FEATURE_COUNT*SECTOR_FEATURE_MEMSIZE + 10
