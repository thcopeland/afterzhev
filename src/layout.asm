...
.equ SECTOR_MEMSIZE = SECTOR_WIDTH*SECTOR_HEIGHT + 4 + SECTOR_NPC_COUNT + SECTOR_PREPLACED_ITEM_COUNT*SECTOR_PREPLACED_ITEM_MEMSIZE + SECTOR_SAVEPOINT_MEMSIZE + SECTOR_PORTAL_COUNT*SECTOR_PORTAL_MEMSIZE + 10
...
.equ SECTOR_PORTALS_OFFSET = SECTOR_SAVEPOINT_OFFSET + SECTOR_SAVEPOINT_MEMSIZE
.equ SECTOR_UPDATE_OFFSET = SECTOR_PORTALS_OFFSET + SECTOR_PORTAL_COUNT*SECTOR_PORTAL_MEMSIZE
.equ SECTOR_ON_ENTER_OFFSET = SECTOR_UPDATE_OFFSET + 2
.equ SECTOR_ON_PICKUP_OFFSET = SECTOR_ON_ENTER_OFFSET + 2
.equ SECTOR_ON_CONVERSATION_OFFSET = SECTOR_ON_PICKUP_OFFSET + 2
...
.equ NPC_TABLE_ENEMY_VELOCITY_OFFSET = 7
.equ NPC_TABLE_ENEMY_ACC_OFFSET = 9
.equ NPC_TABLE_ENEMY_STRENGTH_OFFSET = 11
.equ NPC_TABLE_ENEMY_DEXTERITY_OFFSET = 12
.equ NPC_TABLE_ENEMY_DROPS_OFFSET = 13
.equ NPC_TABLE_ENEMY_DROPS_COUNT = 3
.equ NPC_TABLE_SHOP_IDX_OFFSET = 7
.equ NPC_TABLE_TALKER_CONV1_OFFSET = 7
.equ NPC_TABLE_TALKER_CONV2_OFFSET = 10
.equ NPC_TABLE_TALKER_CONV3_OFFSET = 13
.equ NPC_TABLE_TALKER_CONV_COUNT = 3
...
.equ TOTAL_CONVERSATION_COUNT = 16
...
.equ CLASS_MEMSIZE = 98
.equ CLASS_DIMS_OFFSET = 0
.equ CLASS_SPRITE_OFFSET = 2
.equ CLASS_STATS_OFFSET = 3
.equ CLASS_NAME_OFFSET = 7
.equ CLASS_DESC_OFFSET = 16
...
.equ ITEM_ANIM_ATTACK_FRAMES = 4
.equ ITEM_ANIM_ATTACK_TOTAL_FRAMES = ITEM_ANIM_ATTACK_FRAMES
...
.equ ITEM_LUT_ENTRY_MEMSIZE = ITEM_LUT_ENTRY_FRAME_MEMSIZE*(ITEM_ANIM_WALK_TOTAL_FRAMES + ITEM_ANIM_IDLE_TOTAL_FRAMES + 2*ITEM_ANIM_ATTACK_TOTAL_FRAMES)
