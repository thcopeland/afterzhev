...
.equ AUDIO_SAMPLING_PERIOD = HSYNC_PERIOD*8
.equ AUDIO_BUFFER_SIZE = 14

.if AUDIO_SAMPLING_PERIOD != 512*8
    .error "expected AUDIO_SAMPLING_PERIOD to be 4096, may need to adjust AUDIO_BUFFER_SIZE to avoid overruns"
.endif
...
.equ TOTAL_PREPLACED_ITEM_COUNT = 24
